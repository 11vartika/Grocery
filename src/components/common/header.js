  ...
  return (
    ...
    <div className='topBar'>
      <div className='contactInfo'>
        <ul>
          <li><a href="tel:07450223366"><MobileOutlined /> <span>7651925196</span></a></li>
          <li><a href="mailto:contact@grocery.co.uk"><MailOutlined /> <span>contact@grocery.com</span></a></li>
        </ul>
      </div>
